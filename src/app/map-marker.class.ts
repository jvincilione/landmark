...
*/
declare var google: any, exports: any;
...
export class MapMarker {
     ...
     */
    createMap() {
        // if google isn't loaded, try 5 times with a 250ms delay to run, otherwise, throw error
        if (!window['google'] && this.attempt <= 5) {
            this.attempt++;
            setTimeout(() => {
                this.createMap();
            }, 250);
        } else if (this.attempt > 5 || !google.maps) {
